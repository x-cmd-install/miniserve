...
![miniserve](https://repo.x-cmd.io/miniserve.svg?lang=zh)
...
合计: **8,241** 行代码（覆盖前 5 种语言、共 **44** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 6,938 | 234 | 932 | 33 |
| Sass | 1,066 | 26 | 167 | 6 |
| Svg | 122 | 0 | 0 | 1 |
| Toml | 88 | 9 | 5 | 3 |
| Makefile | 24 | 0 | 4 | 1 |
...
- **最新版本**: `v0.35.0` (2026-04-08)
- **最近提交**: 2026-09-01
- **Release 含资产**: 14 个

## 流行度

- **Star**: 7,846 · **Fork**: 400 · **开放 issue**: 340 · **贡献者**: 69

## 累计统计

- **发布数**: 54 · **已合并 PR**: 675 · **开放 PR**: 13 · **已关闭 issue**: 261 · **开放 issue**: 79 · **提交数**: 2564
...
| last60d | 2026-07-13 | 0 | 0 | 5 | 0 | 1 | 3 |
| 90d | 2026-06-13 | 0 | 1 | 8 | 0 | 3 | 4 |
| last180d | 2026-03-15 | 2 | 6 | 8 | 1 | 8 | 23 |
| 360d | 2025-09-16 | 4 | 19 | 9 | 10 | 10 | 100 |
| last720d | 2024-09-21 | 7 | 48 | 11 | 26 | 29 | 294 |
...
在 [repology.org](https://repology.org/project/miniserve) 上共有 **83** 个发行版报告此项目。**41** 个 ✅ 已是最新上游版本，**42** 个 ⚠️ 使用旧版本。
...
miniserve 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `miniserve` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/miniserve.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T05:00:01Z._
